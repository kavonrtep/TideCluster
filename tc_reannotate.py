#!/usr/bin/env python3
"""Helper script to parse RepeatMasker output and create gff3 file.
Specifically designet to annotate Tandem Repeats."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
            description=(
                "Annotate tandem repeats in a FASTA file using the TRC library from "
